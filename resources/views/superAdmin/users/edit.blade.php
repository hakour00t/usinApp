...
<div class="container w-50">
    ...
    <div class="contaner-sm">
            ...
            <div data-mdb-input-init class="form-outline mb-4 ">
                ...
                <input type="text" id="adress" class="form-control" name="adress"  value="{{ $user->adress }}" />
            </div> 
             <!-- Date -->
            <div data-mdb-input-init class="form-outline mb-4 ">
                <label class="form-label" for="date">Date</label>
                <input type="date" id="date" class="form-control" name="date" value="{{ $user->date }}"/>
            </div>  
            ...
            <div data-mdb-input-init class="form-outline mb-4 ">
                ...
                <select class="custom-select" name="grad"  >
                    <option selected>{{ $user->grad }}</option>
